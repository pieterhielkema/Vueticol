      ...
      ($data.isOpen)
        ? (openBlock(), createElementBlock("div", {
            ...
            createElementVNode("div", _hoisted_4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($props.colors, (color) => {
                return (openBlock(), createElementBlock("div", {
                  ...
                  (color === $data.value)
                    ? (openBlock(), createElementBlock("svg", _hoisted_6, _hoisted_8))
                    : createCommentVNode("v-if", true)
            ...
            ($data.value !== '')
              ? (openBlock(), createElementBlock("div", {
                ...
                }, toDisplayString($props.removeText), 1 /* TEXT */))
              : createCommentVNode("v-if", true)
          ]))
        : createCommentVNode("v-if", true)
    ], 6 /* CLASS, STYLE */)
